...
interface DebugLogsAndAlertsProps {
    t: any;
    response: any;
    status: number;
    route: string | null;
...
export function handleDebugLogsAndAlerts(props: DebugLogsAndAlertsProps) {
...
export function handleRequestError(props: RequestHandlerProps) {
    try {
...
export function handleRequestSuccess(props: RequestHandlerProps) {
    try {
...
const getSimpleApiRoute = (route: string) => route
    .replace("envir.Variables.ApiUrl", "")